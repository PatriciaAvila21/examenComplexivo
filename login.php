...
<body>
   <!--  <img class="wave"src="../assets/img/wave.png" alt="">  -->
    ...
    <div class="div">
     ...
     <input type="email"  id="user"  required placeholder="USUARIO">
    </div>
    </div>
    ...
    <input type="button" class="btn" name="button" id="login" value="Ingresar">
    <a  href="registro.php"> <input type="button" class="btn" name="button" id="registroUsuario" value="Registrarse"></a>
