			...
			<div class="content">
				<div class="page-inner">
					...
					<div class="row">
						...
						<div class="col-md-12">
                          ...
                          foreach ($dato as $key => $value){
                           ...
                           <tr>
							  ...
							  <td><?php echo $va ['apellidop'] ;?></td>
							  <td><?php echo $va ['motivocit'];?></td>
						...
						<button href="#editRowModal=<?php echo $va['codcit'];?>" class="btn btn-link btn-primary btn-lg" data-toggle="modal"  title="" data-original-title="Edit Task" data-target="#editRowModal<?php echo $va['codcit']; ?>">
	...
	function activo(codcit)
{
	...
	$.ajax({
        ...
        window.location.href ='../folder/cita.php';
    })
