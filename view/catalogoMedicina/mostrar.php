	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="../view/perfil-medico/perfin-inicial.php" class="logo">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="../assets/img/perfil-medico.png" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="../assets/img/perfil-medico.png" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4><?php echo ucfirst($_SESSION['nombre']); ?></h4>
												<p class="text-muted">Medico</p><a href="profile.html" class="btn btn-xs btn-secondary btn-sm">Ver perfil</a>
											</div>
										</div>
									</li>
									<li>
						...
						<li class="nav-item active">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="../folder/catalogoMedicina.php">
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Catalogo de Medicina</h4>
						<ul class="breadcrumbs">
							<li class="nav-home">
								<a href="../view/perfil-medico/perfil-inicial.php">
					...
					<div class="row">
						...
						<div class="col-md-12">
								...
								<div class="card-header">
									...
									<div class="card-tools">
										 <a href="../view/especialidad/reporte.php" class="btn btn-info btn-border btn-round btn-sm mr-2">
											...
											<a href="../view/cita/reporte.php" class="btn btn-info btn-border btn-round btn-sm">
												<span class="btn-label">
                          ...
                          foreach ($dato as $key => $value){
                              foreach ($value as $va) { ?>
                           <tr>
                              <td><?php echo $va['codcat'];?></td>
                              <td><?php echo $va['f_ingr'];?></td>
                              <td><?php echo $va['nombre'];?></td>
                              <td><?php echo $va ['f_elavo'] ;?></td>
							  <td><?php echo $va ['f_caduci'] ;?></td>
						...
						<button href="#editRowModal=<?php echo $va['codcat'];?>" class="btn btn-link btn-primary btn-lg" data-toggle="modal"  title="" data-original-title="Edit Task" data-target="#editRowModal<?php echo $va['codcat']; ?>">
									<i class="fa fa-edit"></i>
									
										</button>		
							<button href="#deleteRowModal=<?php echo $va['codcat'];?>" class="btn btn-link btn-danger btn-lg" data-toggle="modal"  title="" data-original-title="Delete Task" data-target="#deleteRowModal<?php echo $va['codcat']; ?>">
