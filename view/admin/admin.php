...
<body>
					...
					<div class="row mt--2">
						<div class="col-md-8">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">Resumen de datos registrados en el sistema</div>
                                          ...
                                          <div class="px-2 pb-2 pb-md-0 text-center">
                                           ...
                                           <div class="px-2 pb-2 pb-md-0 text-center">
                                             <div id="circles-2"></div>
											    ...
											    <h6 class="fw-bold mt-3 mb-0">Medicos</h6>
                                           ...
                                           <div class="px-2 pb-2 pb-md-0 text-center">
                                              <div id="circles-3"></div>
											     ...
											     <h6 class="fw-bold mt-3 mb-0">Citas</h6>
											      ...
											      <?php
                                                  require_once "../config/conexion1.php";
                                                  $sql = "SELECT COUNT(*) total FROM cita";
                                                  $result = $bd->query($sql); //$pdo sería el objeto conexión
                                        ...
                                        <div class="px-2 pb-2 pb-md-0 text-center">
                                            ...
                                            <h6 class="fw-bold mt-3 mb-0">Especialidades</h6>
                                            <?php
                                              require_once "../config/conexion1.php";
	...
	<script>
		...
		Circles.create({
			...
			maxValue:100,
			width:7,
			text: <?php echo  $total4; ?>,
			colors:['#f1f1f1', '#FFFC33'],
			duration:400,
			wrpClass:'circles-wrp',
			textClass:'circles-text',
			styleWrapper:true,
