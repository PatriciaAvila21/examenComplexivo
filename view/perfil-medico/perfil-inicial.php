<?php
  ...
  if(!isset($_SESSION['cargo']) || $_SESSION['cargo'] != 3){
    /*
      ...
      antes de mostrar cualquier informacion en el DOM es por eso que se inserta este
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="perfil-inicial.php" class="logo">
										...
										<div class="row m-0">
											...
											<a class="col-6 col-md-4 p-0" href="#">
												<div class="quick-actions-item">
													...
													<span class="text">Crear nueva publicación</span>
												</div>
											</a>
											<a class="col-6 col-md-4 p-0" href="#">
												<div class="quick-actions-item">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="tables">
								<ul class="nav nav-collapse">
									<li>
										<a href="../../folder/especialidad.php">
											<span class="sub-item">Mostrar</span>
										</a>
									</li>
				...
				<div class="page-inner mt--5">
					<div class="row mt--2">
						<div class="col-md-8">
                            ...
                            <dt>Apellidos;</dt><dd><?php echo ucfirst($_SESSION['nombre']); ?> </dd> 
