										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form method="POST" action="../view/medico/obtener.php?id=<?php echo $va['coddoc']; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="../view/medico/BorrarRegistro.php?coddoc=<?php echo $va['coddoc']; ?>" class="btn btn-danger"><span class="fa fa-times"></span> Eliminar</a>
            </div>
