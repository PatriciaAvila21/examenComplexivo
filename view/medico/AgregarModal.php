        ...
        <div class="modal-content">
			...
			<div class="container-fluid">
                ...
                <div class="card-body">
									  ...
									  <form method="POST" autocomplete="off"  action="../view/medico/nuevo.php">
					   <div class="row">
						<div class="col-sm-12">
							<div class="form-group form-group-default">
								<label>Cedula</label>
								<input name="dnidoc" type="text" class="form-control" maxlength="10" placeholder="Ingrese su cedula" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
							</div>
						</div>
						...
						<div class="col-md-12 pr-0">
							<div class="form-group form-group-default">
								<label>Nombre</label>
								<input name="nomdoc" type="text" class="form-control" placeholder="Ingrese sus nombres">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group form-group-default">
								<label>Apellidos</label>
								<input name="apedoc" type="text" class="form-control" placeholder="Ingrese sus apellidos">
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group form-group-default">
								...
								<select class="form-control" id="doctor"  required name="codespe">
								</select>
								</div>
						</div>
