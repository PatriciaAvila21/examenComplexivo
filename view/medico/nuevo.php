...
if(isset($_POST['agregar'])){
	...
	try{
		...
		$stmt = $db->prepare("INSERT INTO medico (dnidoc, nomdoc,apedoc,codespe,sexo,telefo,fechanaci,correo ,naciona,estado) VALUES (:dnidoc, :nomdoc, :apedoc, :codespe, :sexo,:telefo,:fechanaci,:correo,:naciona,:estado)");
