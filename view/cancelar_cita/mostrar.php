	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="../view/user/user.php" class="logo">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="../../assets/img/paciente.png" alt="Img Profile">
												</div>
												<div class="notif-content">
													<span class="subject">Veronica Lima</span>
													<span class="block">
														Como estas ?
													</span>
											...
											<a href="#">
												...
												<div class="notif-content">
													<span class="subject">Manuel</span>
													<span class="block">
														Ok, gracias !
													</span>
											...
											<a href="#">
												...
												<div class="notif-content">
													<span class="subject">Yair Vera</span>
													<span class="block">
											...
											<a href="#">
												...
												<div class="notif-content">
													<span class="subject">Tamara Lopez</span>
													<span class="block">
														Hola, como estas ?
													</span>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Citas Agendadas</h4>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="#addRowModal" class="btn btn-primary btn-round ml-auto" data-toggle="modal">Registrar Cita</a>
...
if (isset($_SESSION['id'])) {
	...
	$sql = "SELECT cita.codcit, cita.dates, cita.hour, pacientes.codpaci, 
						...
						cita.codespe=especialidad.codespe WHERE pacientes.codpaci='$id'";
